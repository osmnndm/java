...
public class Question09 {
	 ...
	 * 
	 * 
	 * 	// method sonuna return; yazarsak methodu devam ettirmez sonraki satırları okumaz, aynı break 
	// mantığında
	
	// kısayoldan method oluşturma için rehberiGor(); yaz sol taraf numara üzerine tıklayınca aşağıda
	// methodu otomatik oluşturur.
	 * 
	 * */
